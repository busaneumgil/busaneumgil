...
| `ONB` | `ic_user_wheelchair`, `ic_user_visual_impairment`, `ic_user_selected`, `ic_user_check`, `ic_permission_location`, `ic_permission_mic`, `ic_permission_notification` | 선택 카드와 권한 카드는 아이콘 의미를 제목/설명으로 반복 제공한다. |
