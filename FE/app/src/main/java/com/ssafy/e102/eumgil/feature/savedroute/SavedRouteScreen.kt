...
fun SavedRouteScreen(
    ...
    EumPlaceholderScaffold(
        title = stringResource(id = R.string.saved_route_screen_title),
        description = stringResource(id = R.string.saved_route_screen_description),
        featurePath = stringResource(id = R.string.feature_path_saved_route),
        actions = listOf(
            PlaceholderAction(
