...
@Composable
fun RouteDetailPlaceholderScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            RouteStateCard(
                title =
                    stringResource(
                        id = R.string.route_setting_detail_placeholder_title,
                        routeOption.routeOptionTitle(),
                    ),
                description = stringResource(id = R.string.route_setting_detail_placeholder_description),
