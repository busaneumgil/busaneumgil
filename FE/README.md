...
또한 로그인 없이도 주요 탐색 흐름을 사용할 수 있는 local-first 구조를 유지하면서, 서버 API와 연동되는 경로 탐색, 즐겨찾기, 제보, 사용자 설정 흐름을 Android 환경에 맞게 제공합니다.
...
- **local-first 사용성**: 비로그인 상태에서도 기본 탐색과 안내 흐름을 사용할 수 있도록 구성
