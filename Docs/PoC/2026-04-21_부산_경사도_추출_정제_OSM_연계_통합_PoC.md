...
- [2026-04-12_ERD_초안.md](/C:/Users/SSAFY/Desktop/Project/S14P31E102/Docs/ARD/2026-04-12_ERD_초안.md)
...
| `width_meter` | 폭 |
| `has_stairs` | 계단 여부 |
| `has_elevator` | 엘리베이터 연결 여부 |
| `has_crosswalk` | 횡단보도 포함 여부 |
| `has_signal` | 신호 여부 |
| `has_audio_signal` | 음향신호기 여부 |
| `has_braille_block` | 점자블록 여부 |
| `surface_type` | 노면 타입 |
...
- 현재 단계에서는 `has_stairs = false`가 아니라 `stairs_data_status = MISSING_SOURCE`로 다루는 것이 정확하다.
